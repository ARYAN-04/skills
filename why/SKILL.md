...
Before spawning investigators, list the available MCPs from the agent environment. Use the available-tools map when present. Otherwise inspect the configuration or directories exposed for enabled MCP servers.
